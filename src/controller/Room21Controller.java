 ...
 */
public class Room21Controller implements Initializable{
    ...
    void changeScene(MouseEvent event) throws IOException {
        gc.changeScene(layoutPlayer, "door21", "/view/corridor.fxml", "Corridor", textArea, event);
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Item[] nightstandItems;
        if(getItem(layoutPlayer, "key21") != null) {
            nightstandItems = new Item[]{getItem(layoutPlayer, "nightstand"), getItem(layoutPlayer, "fishbowl"), getItem(layoutPlayer, "key21")};
        } else {
            nightstandItems = new Item[]{getItem(layoutPlayer, "nightstand"), getItem(layoutPlayer, "fishbowl")};
        }

        Item[] deskItems;
        if(getItem(layoutPlayer, "journal") != null) {
            deskItems = new Item[]{getItem(layoutPlayer, "desk"), getItem(layoutPlayer, "journal")};
        } else {
            deskItems = new Item[]{getItem(layoutPlayer, "desk")};
        }
