 ...
 */
public class Room18Controller implements Initializable{
    ...
    void changeScene(MouseEvent event) throws IOException {
        gc.changeScene(layoutPlayer, "door18", "/view/corridor.fxml", "Corridor", textArea, event);
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        ImageView[] imgs03 = {desk, biblio, biblio2};
        ...
        Item[] safeItems = {getItem(layoutPlayer, "safe")};
        Item[] commodeItems = {getItem(layoutPlayer, "commode")};
        Item[] deskItems = {getItem(layoutPlayer, "desk")};
        Item[] bookshelf2Items = {getItem(layoutPlayer, "bookshelf2")};
        
        Item[] bookshelf1Items;
        if(getItem(layoutPlayer, "book") != null && getItem(layoutPlayer, "candle") != null) {
            bookshelf1Items = new Item[]{getItem(layoutPlayer, "bookshelf"), getItem(layoutPlayer, "book"), getItem(layoutPlayer, "candle")};
        } else {
            bookshelf1Items = new Item[]{getItem(layoutPlayer, "bookshelf")};
        }
        ...
        roomItems.put(biblio, bookshelf1Items);
        roomItems.put(biblio2, bookshelf2Items);
    }
}
