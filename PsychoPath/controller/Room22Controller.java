 ...
 */
public class Room22Controller implements Initializable{
    ...
    void changeScene(MouseEvent event) throws IOException {
        gc.changeScene(layoutPlayer, "door22", "/view/corridor.fxml", "Corridor", textArea, event);
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Item[] deskItems;
        if(getItem(layoutPlayer, "paper") != null && getItem(layoutPlayer, "key22") != null) {
            deskItems = new Item[]{getItem(layoutPlayer, "desk"), getItem(layoutPlayer, "paper"), getItem(layoutPlayer, "key22")};
        } else {
